...
const ChildrenStats = ({ children }: { children: ChildWithRelation[] }) => (
      ...
      <CardContent className="p-6">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-2xl font-bold">{children.filter((c) => c.is_active).length}</p>
          </div>
        </div>
      </CardContent>
    </Card>
      ...
      <CardContent className="p-6">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-2xl font-bold">{children.filter((c) => c.can_edit).length}</p>
          </div>
        </div>
      </CardContent>
    </Card>
      ...
      <CardContent className="p-6">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-2xl font-bold">{children.filter((c) => c.diagnosis).length}</p>
          </div>
        </div>
      </CardContent>
    </Card>
...
// ================================================================
// COMPONENTE DE VISTA DE CONTENIDO
// ================================================================
    ...
    <Card>
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {/* Rango de edad */}
          <div className="space-y-2">
            <label htmlFor="max-age-input" className="text-sm font-medium">
              Edad máxima
            </label>
            <Input
              id="max-age-input"
              ...
              onChange={(e) =>
                onFiltersChange({
                  ...filters,
                  max_age: e.target.value ? Number.parseInt(e.target.value) : undefined,
                })
              }
            />
          </div>
...
export default function ChildrenPage() {
  ...
  const renderContent = () => {
    ...
    if (filteredChildren.length === 0) {
      return <EmptyState hasChildren={children.length > 0} onClearFilters={handleClearFilters} />
    }
